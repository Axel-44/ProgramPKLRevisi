// src/components/SurveiKorupsiModal.tsx
"use client";
...
export function SurveiKorupsiModal({ isOpen, onClose }: SurveiModalProps) {
    if (!isOpen) return null;
    
    const surveiUrl = "https://bkad.kotabogor.go.id/survey-persepsi-korupsi";
            ...
            >
                ...
                <div className="text-center">
                    <div className="p-6 text-blue-900 border-b border-gray-200 mb-6">
                        <h3 className="font-bold text-2xl mb-2">Survei Persepsi Anti Korupsi</h3>
                        <p className="text-sm">
                            Survei ini bertujuan untuk mengukur persepsi anti korupsi di lingkungan BKAD Kota Bogor.
                        </p>
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                            <li>Pengelola Keuangan</li>
                            <li>Pengelolaan BMD</li>
                            <li>Penyusunan Anggaran</li>
                        </ul>
                    </div>
